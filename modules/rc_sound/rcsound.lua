...
SOUNDS = {
        ...
        {fromPos = {x=1236, y=865, z=3}, toPos = {x=1247, y=880, z=7}, priority = 2, sound="The Sight of Spira.ogg"},  ------- temple mihen
        {fromPos = {x=1396, y=794, z=7}, toPos = {x=1601, y=946, z=7}, priority = 2, sound="Mi'hen Highroad.ogg"},  ----- roshamuul
